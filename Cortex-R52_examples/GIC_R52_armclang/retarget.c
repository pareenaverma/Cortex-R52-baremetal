...
extern void	pl011_xmt_char(char);
extern char	pl011_rcv_char(void);
extern void pl011_start(void);
extern void pl011_stop(void);

/*
 * UART prototype functions
 */
void (*UART_open)(void) = &pl011_start;
void (*UART_close)(void) = &pl011_stop;
void (*UART_write)(char) = &pl011_xmt_char;
char (*UART_read)(void) = &pl011_rcv_char;
